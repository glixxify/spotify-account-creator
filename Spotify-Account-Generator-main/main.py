...
def createAccount():
  ...
  name = "glixxify" + str(random.randint(100, 999))
  email = "glixxify" + str(random.randint(100, 9999)) + "@gmail.com"
  password = "glixxify" + str(random.randint(100, 999))
...
def send():
  ...
  print("Tool created by glixxify#3911")
